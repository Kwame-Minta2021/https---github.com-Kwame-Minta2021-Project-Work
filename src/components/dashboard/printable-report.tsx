      ...
      <div ref={ref} className="p-8 font-sans text-sm bg-white text-black">
        <header className="mb-8 text-center">
          <h1 className="text-3xl font-bold text-primary mb-2" style={{ color: '#64B5F6' }}>
            {/* This title can also be translated if needed */}
            BreatheEasy Air Quality Report 
          </h1>
        ...
        {aiAnalysis && (
          <section>
            <h2 className="text-xl font-semibold border-b-2 border-primary pb-2 mb-4 flex items-center" style={{ color: '#64B5F6', borderColor: '#64B5F6' }}>
              ...
              {t('rlModelAnalysis')} {/* Translated */}
            </h2>
            <div className="mb-6">
              <h3 className="text-lg font-medium mb-2 text-gray-700">{t('effectOnHumanHealth')}</h3> {/* Translated */}
              <p className="text-gray-800 whitespace-pre-line leading-relaxed">
                {aiAnalysis.effectOnHumanHealth || 'No health impact analysis available.'}
              </p>
            </div>
            <div>
              <h3 className="text-lg font-medium mb-2 text-gray-700">{t('bestActionToReducePresence')}</h3> {/* Translated */}
              <p className="text-gray-800 whitespace-pre-line leading-relaxed">
